...
namespace Modbus {
    ...
    public class Mapping {
        ...
        [CCode (cname = "modbus_mapping_offset_new")]
        public Mapping.with_offset (int nb_bits, int offset_bits, int nb_input_bits, int offset_input_bits,
                int nb_registers, int offset_registers, int nb_input_registers, int offset_input_registers);
    }
